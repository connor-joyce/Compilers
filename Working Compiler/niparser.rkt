...
;;;     [(logicexpr) $1]
    ...
    (logicexpr
     [(logicexpr BOOLAND arithmeticexpr) (LogicExpr $1 'and $3)]
     [(logicexpr BOOLOR arithmeticexpr) (LogicExpr $1 'or $3)]
    ; [(BOOLNOT logicexpr) (LogicExpr $2 'not #f)]
     [(arithmeticexpr) $1])
    ...
    #;(compexpr
     ...
     (compexpr
     [(logicexpr EQ logicexpr) (BoolExpr $1 'eq $3)]
     [(logicexpr LT logicexpr) (BoolExpr $1 'lt $3)]
     [(logicexpr GT logicexpr) (BoolExpr $1 'gt $3)]
     [(logicexpr GE logicexpr) (BoolExpr $1 'ge $3)]
     [(logicexpr LE logicexpr) (BoolExpr $1 'le $3)]
     [(logicexpr NE logicexpr) (BoolExpr $1 'ne $3)]
     [(logicexpr) $1])
